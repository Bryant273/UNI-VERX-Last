...
export default function ProfessorTicketsPage() {
  const [tickets, setTickets] = useState<Ticket[]>(ticketsData.filter(t => t.author === 'Dr. Évelyne Dubois'));
  ...
  const handleCreateTicket = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newTicket: Ticket = {
      ...
      status: 'open',
      author: 'Dr. Évelyne Dubois', // Assuming the current user
      messages: [
        {
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p className="text-muted-foreground">Suivez et gérez vos requêtes auprès de l'administration.</p>
        </div>
          ...
          <form onSubmit={handleCreateTicket}>
            <div className="space-y-4 py-4 max-h-[70vh] overflow-y-auto pr-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="subject" name="subject" placeholder="Ex: Problème de connexion à la plateforme" required/>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-6 py-4 max-h-[60vh] overflow-y-auto pr-4">
                   {selectedTicket.messages.map((msg, index) => (
                       <div key={index} className="flex flex-col gap-2">
                            ...
                            <div className={cn("p-4 rounded-lg", msg.author === 'Dr. Évelyne Dubois' ? 'bg-muted/50' : 'bg-primary/10')}>
