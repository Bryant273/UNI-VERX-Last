          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             ...
             <div className="space-y-1">
                ...
                <Input id="email" type="email" defaultValue="jean.moreau@univ.fr" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                    <Label htmlFor="phone">Téléphone</Label>
                    <Input id="phone" type="tel" defaultValue="+33 1 23 45 67 88" />
                </div>
                <div className="space-y-1">
                    <Label htmlFor="office">Bureau</Label>
                    <Input id="office" defaultValue="C201" />
                </div>
            </div>
            
             <div className="space-y-1">
              <Label htmlFor="bio">Biographie succincte</Label>
              <Textarea id="bio" placeholder="Parlez un peu de vous..." defaultValue="Responsable pédagogique du département Informatique avec plus de 15 ans d'expérience dans l'accompagnement des étudiants et l'ingénierie pédagogique." />
            </div>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
                <h4 className="font-semibold">Types de notifications</h4>
                 <div className="flex items-center justify-between">
                     <div>
                        <p className="text-sm">Alertes étudiantes critiques</p>
                        <p className="text-xs text-muted-foreground">Absences répétées, chute de notes, etc.</p>
                    </div>
                    <Switch defaultChecked/>
                </div>
                 <div className="flex items-center justify-between">
                     <div>
                        <p className="text-sm">Demandes de validation</p>
                        <p className="text-xs text-muted-foreground">Nouvelles notes à valider, modifications de planning...</p>
                    </div>
                    <Switch defaultChecked/>
                </div>
            </div>
...
const PedagogySection = () => (
    <div className="space-y-6">
        <Card>
            ...
            <CardContent className="space-y-6">
                <div>
                    <Label>Seuil d'alerte pour absence (par matière)</Label>
                     <div className="flex items-center gap-4">
                         <Slider defaultValue={[20]} max={50} step={5} />
                         <span className="text-sm font-medium">20%</span>
                     </div>
                     <p className="text-xs text-muted-foreground mt-1">Générer une alerte si le taux d'absence d'un étudiant dans une matière dépasse ce seuil.</p>
                </div>
                 <div>
                    <Label>Seuil d'alerte pour chute de moyenne</Label>
                     <div className="flex items-center gap-4">
                         <Slider defaultValue={[3]} max={10} step={0.5} />
                         <span className="text-sm font-medium">3 points</span>
                     </div>
                     <p className="text-xs text-muted-foreground mt-1">Générer une alerte si la moyenne d'un étudiant chute de plus de X points.</p>
                </div>
            </CardContent>
        </Card>
         <div className="flex justify-end">
