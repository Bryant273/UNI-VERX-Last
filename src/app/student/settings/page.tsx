...
const ProfileSettingsTab = () => {
    ...
    return (
        <div className="space-y-6">
                ...
                <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative w-28 h-28">
                            <Avatar className="w-full h-full"><AvatarImage src={avatar} /><AvatarFallback>{getInitials(studentData.name)}</AvatarFallback></Avatar>
            ...
            <SettingsCard title="Informations académiques">
    ...
    return (
        <div className="space-y-6">
            <SettingsCard title="Visibilité du profil">
                <div className="space-y-6 divide-y divide-border">
                    <div className="flex items-center justify-between pt-6 first:pt-0"><div><h4 className="font-medium">Visible par les autres étudiants</h4><p className="text-sm text-muted-foreground">Permet aux autres de voir votre profil.</p></div><Switch id="profile-visible-students" defaultChecked /></div>
                    <div className="flex items-center justify-between pt-6"><div><h4 className="font-medium">Visible par les entreprises</h4><p className="text-sm text-muted-foreground">Permet aux partenaires de voir votre profil.</p></div><Switch id="profile-visible-companies" defaultChecked /></div>
                </div>
            </SettingsCard>
