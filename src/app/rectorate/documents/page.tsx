...
export default function RectorateDocumentsPage() {
    ...
    return (
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    <CardTitle>Documents du Rectorat</CardTitle>
                    <CardDescription>Gérez les documents officiels et stratégiques de l'université.</CardDescription>
                </CardHeader>
            </Card>
            ...
            <Tabs defaultValue="administrative" className="w-full">
                <TabsList className="grid w-full grid-cols-3">
                    ...
                    <TabsTrigger value="professional"><Book className="mr-2"/>Publications</TabsTrigger>
