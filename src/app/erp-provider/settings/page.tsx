            ...
            >
                <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div><Label htmlFor="email">Email professionnel</Label><Input id="email" type="email" defaultValue={`contact@innov-korp.com`} /></div>
                        <div><Label htmlFor="phone">Téléphone</Label><Input id="phone" type="tel" defaultValue="+33 1 98 76 54 32" /></div>
                         <div><Label>Rôle</Label><Input value="Fournisseur ERP" disabled /></div>
                    </div>
                </form>
            </SettingsCard>
        </div>
