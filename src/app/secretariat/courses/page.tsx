...
const CoursesTab = () => {
    ...
    const filteredCourses = useMemo(() => {
        ...
        return courses.filter(c => 
            (teacherFilter === 'all' || !teacherFilter || c.uploader === teacherFilter) &&
            (levelFilter === 'all' || !levelFilter || c.level === levelFilter) &&
            (classFilter === 'all' || !classFilter || c.class === classFilter) &&
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <Select value={teacherFilter} onValueChange={setTeacherFilter}><SelectTrigger><SelectValue placeholder="Tous les enseignants"/></SelectTrigger><SelectContent><SelectItem value="all">Tous les enseignants</SelectItem>{uniqueTeachers.map(t => <SelectItem key={t} value={t}>{t}</SelectItem>)}</SelectContent></Select>
