...
export const allResources: Resource[] = [
    { id: 1, name: "Bases de Données", type: "folder", subject: "bdd", category: "", size: "7.4 MB", views: 0, modified: "15/05/2025", shared: true, downloadable: true, fileCount: 3 },
    { id: 2, name: "Python", type: "folder", subject: "python", category: "", size: "7.0 MB", views: 0, modified: "12/05/2025", shared: true, downloadable: true, fileCount: 3 },
    { id: 9, name: "Algorithmique", type: "folder", subject: "algo", category: "", size: "N/A", views: 0, modified: "25/04/2025", shared: true, downloadable: true, fileCount: 1 },
    { id: 11, name: "Développement Web", type: "folder", subject: "web", category: "", size: "N/A", views: 0, modified: "05/05/2025", shared: true, downloadable: true, fileCount: 1 },
];

export const filesInsideFolders: { [key: string]: Resource[] } = {
    "bdd": [
        ...
        { id: 101, name: "Introduction BDD.pdf", type: "pdf", subject: "bdd", category: "course", size: "1.8 MB", views: 300, modified: "15/05/2025", shared: true, downloadable: true, description: "Introduction aux bases de données relationnelles" },
    ],
    "python": [
